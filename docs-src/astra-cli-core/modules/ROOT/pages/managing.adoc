...
Use the `astra db list-collections` command to get a list of the collections in a {db-serverless-vector} database:
...
.Expand to see all `db list-collection` options
[%collapsible]
====
[source,console]
----

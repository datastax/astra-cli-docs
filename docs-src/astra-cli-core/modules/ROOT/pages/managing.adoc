...
[WARNING]
====
The generated `.env` files contains sensitive information, including the application token that the {product} uses to connect to the .
...
The {product} lets you manage multiple Astra organizations.
To facilitate this, the {product} lets you create multiple configurations within the `~/.astrarc` file.
Each configuration is associated with an application token, enabling you to manage multiple organizations, or manage one organization using multiple application tokens.

...
:product-repo-name: <insert repo name>
:product-repo-name-long: <insert GitHub org name>/<insert repo name>
:product-repo-link: <insert repo clone URL>
:product-branch-name: <insert branch name>
:docset-name: <insert doc short name>
:product-branch-link: <insert link to doc branch>
...
[NOTE]
====
This is a repo template meant to be used when creating a new documentation repo.
It contains a basic set of infrastructure components that can be modified to get documentation building quickly with Antora.
Click the *Use this template* button to create a new repository from this template.

.Don't forget to modify this README
. Insert the necessary information into the following attributes in the README header:
+
[source,asciidoc]
----
:product: <insert product name>
...
:product-repo-link: <insert repo clone URL>
:product-branch-name: <insert branch name>
:docset-name: <insert bsys build name>
:product-branch-link: <insert link to doc branch>
----
+
These attributes will populate the necessary information throughout the README, saving you lots of time and effort.
. Delete this NOTE.
====

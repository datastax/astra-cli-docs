...
| `region`
| `String` (OPTIONAL)
| A valid xref:databases:regions.adoc[cloud provider region], depending on your xref:administration:subscription-plans.adoc[plan] and the database type.
...
Permanently delete a database, erasing all data stored in it and all backups.

...
[source,shell]
----
astra pcu create [-qV] [--no-input] [--[no-]spinner] [--color[=WHEN]]
                 [--dump-logs[=FILE]] [-h[=all]] [-c=CLOUD] [-d=DESC]
                 [-it=TYPE] [--max=MAX] [--min=MIN] [-o=FORMAT] [-pt=TYPE]
                 [-r=REGION] [--reserved=RESERVED] [[[-cf=PATH] [-p=NAME]] |
                 [--token=TOKEN [--env=ENV]]] [--if-not-exists |
                 --allow-duplicate-names] GROUP

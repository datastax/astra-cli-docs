...
[source,shell]
----
astra db [-qvV] [--no-input] [--[no-]spinner] [--color[=WHEN]] [--dump-logs
         [=FILE]] [-h[=all]] [-o=FORMAT] [[[-cf=PATH] [-p=NAME]] |
...
* xref:astra-db-data-api.adoc[astra db data-api]
...
* xref:astra-db-list-reranking-providers.adoc[astra db list-reranking-providers]
...
* xref:astra-db-regions.adoc[astra db regions]
* xref:astra-db-endpoints.adoc[astra db endpoints]

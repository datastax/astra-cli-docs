...
astra db create-dotenv [-qV] [--no-input] [--[no-]overwrite] [--print] [--[no-]
                       spinner] [--color[=WHEN]] [--dump-logs[=FILE]] [-h
                       [=all]] [--file=FILE] [-k=KEYSPACE] [-o=FORMAT]
                       [-r=REGION] [[[-cf=PATH] [-p=NAME]] | [--token=TOKEN
                       [--env=ENV]]] [--keys=KEYS[,KEYS...] [--keys=KEYS[,
                       KEYS...]]... | --preset=PRESETS[,PRESETS...]
                       [--preset=PRESETS[,PRESETS...]]...] [DB]

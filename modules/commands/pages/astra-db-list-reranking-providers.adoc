= astra db list-reranking-providers

[source,shell]
----
astra db list-reranking-providers [-qV] [--no-input] [--[no-]spinner] [--color
...
Find all available reranking providers for a given database
...
[source,bash]
----
# Find all available reranking providers for a database
$ astra db list-reranking-providers my_db
----

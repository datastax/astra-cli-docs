= astra db regions serverless

[source,shell]
----
astra db regions serverless [-aqV] [--no-input] [--[no-]spinner] [--color
                            [=WHEN]] [--dump-logs[=FILE]] [-h[=all]]
                            [-o=FORMAT] [-c=FILTER[,FILTER...]]... [-f=FILTER[,
...
$ astra db regions serverless --cloud AWS,GCP

# Filter by partial region name
$ astra db regions serverless --filter us-,ca-

# Filter by zone
$ astra db regions serverless --zone Europe
----

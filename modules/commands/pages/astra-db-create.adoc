...
astra db create [-qV] [--[no-]async] [--no-input] [--non-vector] [--[no-]
                spinner] [--color[=WHEN]] [--dump-logs[=FILE]] [-h[=all]]
                [-c=CLOUD] [--capacity-units=CAPACITY UNITS] [-k=KEYSPACE]
                [-o=FORMAT] [-pg=PCU_GROUP] [-r=REGION] [--tier=TIER]
                [--timeout=<timeout>] [[[-cf=PATH] [-p=NAME]] | [--token=TOKEN
                [--env=ENV]]] [--if-not-exists | --allow-duplicate-names] DB

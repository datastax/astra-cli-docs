= astra db regions classic

[source,shell]
----
astra db regions classic [-qV] [--no-input] [--[no-]spinner] [--color[=WHEN]]
...
$ astra db regions classic --cloud AWS,GCP

# Filter by partial region name
$ astra db regions classic --filter us-,ca-

# Filter by zone
$ astra db regions classic --zone Europe
----

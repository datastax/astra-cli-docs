...
[source,shell]
----
astra pcu [-qV] [--no-input] [--[no-]spinner] [--color[=WHEN]] [--dump-logs
...
* xref:astra-pcu-find-association.adoc[astra pcu find-association]
* xref:astra-pcu-transfer-association.adoc[astra pcu transfer-association]
* xref:astra-pcu-list-types.adoc[astra pcu list-types]
